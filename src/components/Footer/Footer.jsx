...
import linkedinIcon from '../../assets/assets/instagram.png'
        ...
        <Box sx={{ py: 10, backgroundColor: '#FFF6B2' }}>
            <CustomContainer>
                ...
                <Box>
                    ...
                    >
                        Keep i touch with our social media pages...
                    </Typography>
                    <IconBox>
                        <img src={fbIcon} style={{ cursor: 'pointer' }} />
                        <img src={twitterIcon} style={{ cursor: 'pointer' }} />
